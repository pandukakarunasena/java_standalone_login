...
public final class Constants {
  ...
  // SQL queries
  public static final String INSERT_NEW_USER_QUERY =
      "INSERT INTO user(username, email, address, password) VALUES (?,?,?,?)";
  public static final String GET_USER_QUERY =
      "SELECT * FROM user WHERE user.username=? AND user.email=?";
  ...
  public static final String DATABASE_CONFIG_FILE_PATH =
      "E:\\spring\\javastandalonelogin\\resources\\config.properties";
}
