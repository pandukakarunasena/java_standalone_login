...
public class UserDAOImpl implements UserDAO {
  ...
  /**
   * add a new user to the database in the database the id is auto generated
   *
  ...
  /**
   * @param userName entered username when login
   * @param email entered password when login
   * @return User data transfer object if a User record exist in the database otherwise null
   */
  @Override
    ...
    try {
      ...
      ps =
          Database.getInstance()
              .getConnection()
              .prepareStatement(getNewUserByUsernameAndEmailQuery);
      ...
      if (rs.next()) {
        user =
            new UserDTO(
                rs.getString(Constants.DATABASE_FIELD_USERNAME),
